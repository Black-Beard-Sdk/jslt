...
namespace Bb.Expressions.CsharpGenerators
{
    internal sealed partial class LocalCSharpCodeGenerator : ICodeCompiler, ICodeGenerator
    {
        ...
        internal LocalCSharpCodeGenerator() { }

        internal LocalCSharpCodeGenerator(IDictionary<string, string> providerOptions)
        {
        ...
        public void GenerateCodeFromMember(CodeTypeMember member, TextWriter writer, CodeGeneratorOptions options)
        {
            if (_output != null)
            {
                throw new InvalidOperationException(ResourceString.CodeGenReentrance);
            }
        ...
        private void GeneratePrimitiveExpression(CodePrimitiveExpression e)
        {
            ...
            {
                throw new ArgumentException(string.Format(ResourceString.InvalidPrimitiveType, e.Value.GetType()), nameof(e));
            }
        }
        ...
        private void GenerateIterationStatement(CodeIterationStatement e)
        {
            ...
            if (e.InitStatement != null && e.IncrementStatement != null)
            {
                Output.Write("for (");
        ...
        public void ValidateIdentifier(string value)
        {
            ...
            {
                throw new ArgumentException(string.Format(ResourceString.InvalidIdentifier, value), nameof(value));
            }
        }
