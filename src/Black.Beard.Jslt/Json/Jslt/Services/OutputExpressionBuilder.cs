...
namespace Bb.Json.Jslt.Services
{
    ...
    internal class OutputExpressionBuilder : IJsltJsonVisitor
    {
        ...
        internal Func<RuntimeContext, JToken, StringBuilder> GenerateLambdaOutput(JsltBase tree, string filepathCode)
        {
            ...
            var result = _compiler.Compile<Func<RuntimeContext, JToken, StringBuilder>>(filepathCode);
