...
namespace Bb.Jslt
{
    ...
    public class RuntimeContext
    {
        ...
        static RuntimeContext()
        {
            ...
            _getContentByJPath = GetContentByJPath;
            _getContentFromService = GetContentFromService;
            _evaluateUnaryOperator = EvaluateUnaryOperator;
            _evaluateBinaryOperator = EvaluateBinaryOperator;
            ...
            _convertToken = ConvertTo;
            _translateVariable = Translate;

            _setVariable = typeof(RuntimeContext).GetMethod(nameof(SetVariable), new Type[] { typeof(RuntimeContext), typeof(string), typeof(object), typeof(TextLocation) });
            _getVariable = typeof(RuntimeContext).GetMethod(nameof(GetVariable), new Type[] { typeof(RuntimeContext), typeof(string), typeof(Type), typeof(TextLocation) });
            _DelVariable = typeof(RuntimeContext).GetMethod(nameof(DelVariable), new Type[] { typeof(RuntimeContext), typeof(string) });
            ...
            _ScriptProperty = typeof(RuntimeContext).GetProperty(nameof(ScriptFile));
        ...
        private static bool Equal(object l, object r)
        {
            ...
            else if (l is short left_int16)
                return left_int16 == Convert.ToInt64(r);

            else if (l is ushort left_uint16)
                return left_uint16 == Convert.ToUInt64(r);

            else if (l is uint left_uint32)
                return left_uint32 == Convert.ToUInt64(r);

            else if (l is ulong left_uint64)
        ...
        public static void SetVariable(RuntimeContext ctx, string name, object value, TextLocation trace)
        {
        ...
        public static JToken Translate(RuntimeContext ctx, string text, string[] keys, TextLocation trace)
        {
