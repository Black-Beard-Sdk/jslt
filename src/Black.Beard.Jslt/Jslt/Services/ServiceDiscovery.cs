...
namespace Bb.Jslt.Services
{
    ...
    public partial class ServiceDiscovery
    {
        ...
        /// <summary>
        /// explore the assembly and add services in the configuration container. the type must to have an attribute <see cref="Attributes.JsltExtensionMethodAttribute" /> for identify the key to match.
        /// </summary>
        ...
        /// <summary>
        /// Add services in the configuration container. the type must to have an attribute <see cref="Attributes.JsltExtensionMethodAttribute" /> for identify the key to match.
