...
namespace Bb.Jslt
{
    ...
    public class JsltTemplate
    {
        ...
        {
            RuntimeContext result = Transform(sources);
        ...
        {
            RuntimeContext result = Transform(ctx);
            return ApplyOutput(result);
        }
        ...
        /// <param name="ctx">The CTX.</param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException">ctx</exception>
        ...
        public RuntimeContext GetContext(Sources sources)
        {
            ...
            return new RuntimeContext(sources, Diagnostics)
            {
